...
st.write(":red[This tool is for educational purposes only and is :bold[NOT] a substitute for professional medical advice. Always consult a qualified healthcare provider for diagnosis and treatment.]")
